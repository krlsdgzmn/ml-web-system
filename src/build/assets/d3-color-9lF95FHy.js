...
var b = 0.7,
  ...
  n = "\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)%\\s*",
  O = /^#([0-9a-f]{3,8})$/,
  S = new RegExp(`^rgb\\(${o},${o},${o}\\)$`),
  z = new RegExp(`^rgb\\(${n},${n},${n}\\)$`),
  L = new RegExp(`^rgba\\(${o},${o},${o},${g}\\)$`),
  A = new RegExp(`^rgba\\(${n},${n},${n},${g}\\)$`),
  B = new RegExp(`^hsl\\(${g},${n},${n}\\)$`),
  D = new RegExp(`^hsla\\(${g},${n},${n},${g}\\)$`),
  H = {
    aliceblue: 15792383,
  ...
  return (
    ...
    (r = O.exec(e))
      ...
      : (r = S.exec(e))
        ? new a(r[1], r[2], r[3], 1)
        : (r = z.exec(e))
          ? new a((r[1] * 255) / 100, (r[2] * 255) / 100, (r[3] * 255) / 100, 1)
          : (r = L.exec(e))
            ? m(r[1], r[2], r[3], r[4])
            : (r = A.exec(e))
              ? m(
              ...
              : (r = B.exec(e))
                ? P(r[1], r[2] / 100, r[3] / 100, 1)
                : (r = D.exec(e))
                  ? P(r[1], r[2] / 100, r[3] / 100, r[4])
                  : H.hasOwnProperty(e)
                    ? q(H[e])
                    : e === "transparent"
                      ? new a(NaN, NaN, NaN, 0)
...
function J(e) {
  return (
    e instanceof u || (e = v(e)),
    e ? ((e = e.rgb()), new a(e.r, e.g, e.b, e.opacity)) : new a()
  );
}
function K(e, r, t, f) {
...
k(
  ...
  I(u, {
    brighter(e) {
      return (
        (e = e == null ? w : Math.pow(w, e)),
        new a(this.r * e, this.g * e, this.b * e, this.opacity)
      );
    },
    darker(e) {
      return (
        (e = e == null ? b : Math.pow(b, e)),
        new a(this.r * e, this.g * e, this.b * e, this.opacity)
      );
    },
    rgb() {
...
function j(e) {
  ...
  if ((e instanceof u || (e = v(e)), !e)) return new i();
  ...
  return (
    s
      ? (r === c
        ...
        (d *= 60))
      : (s = p > 0 && p < 1 ? 0 : d),
    new i(d, s, p, e.opacity)
  );
}
function T(e, r, t, f) {
  return arguments.length === 1 ? j(e) : new i(e, r, t, f ?? 1);
}
function i(e, r, t, f) {
...
k(
  ...
  I(u, {
    ...
    clamp() {
      return new i(C(this.h), y(this.s), y(this.l), $(this.opacity));
    },
    displayable() {
      return (
    ...
    formatHsl() {
      const e = $(this.opacity);
      return `${e === 1 ? "hsl(" : "hsla("}${C(this.h)}, ${y(this.s) * 100}%, ${y(this.l) * 100}%${e === 1 ? ")" : `, ${e})`}`;
    },
  }),
);
function C(e) {
