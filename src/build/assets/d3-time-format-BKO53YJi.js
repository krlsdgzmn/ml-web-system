  ...
  function h(a, o) {
    return function (c) {
      var r = [],
        ...
        p,
        Z;
      for (c instanceof Date || (c = new Date(+c)); ++l < m; )
        a.charCodeAt(l) === 37 &&
          (r.push(a.slice(i, l)),
          (p = I[(y = a.charAt(++l))]) != null
            ? (y = a.charAt(++l))
            : (p = y === "e" ? " " : "0"),
          (Z = o[y]) && (y = Z(c, p)),
          r.push(y),
          (i = l + 1));
      return r.push(a.slice(i, l)), r.join("");
    };
  }
  function A(a, o) {
    return function (c) {
      var r = v(1900, void 0, 1),
        l = b(r, a, (c += ""), 0),
        i,
        m;
      ...
      if (
        ...
        ("W" in r || "U" in r) &&
          ...
          (m =
            "Z" in r ? H(v(r.y, 0, 1)).getUTCDay() : F(v(r.y, 0, 1)).getDay()),
          (r.m = 0),
          (r.d =
            "W" in r
              ? ((r.w + 6) % 7) + r.W * 7 - ((m + 5) % 7)
              : r.w + r.U * 7 - ((m + 6) % 7)));
      return "Z" in r
        ? ((r.H += (r.Z / 100) | 0), (r.M += r.Z % 100), H(r))
        : F(r);
    };
  }
  function b(a, o, c, r) {
    for (var l = 0, i = o.length, m = c.length, y, p; l < i; ) {
      if (r >= m) return -1;
      if (((y = o.charCodeAt(l++)), y === 37)) {
        if (
          ((y = o.charAt(l++)),
          (p = se[y in I ? o.charAt(l++) : y]),
          !p || (r = p(a, c, r)) < 0)
        )
          return -1;
      } else if (y != c.charCodeAt(r++)) return -1;
    }
    return r;
  }
  function le(a, o, c) {
    var r = ee.exec(o.slice(c));
    return r ? ((a.p = ne.get(r[0].toLowerCase())), c + r[0].length) : -1;
  }
  function me(a, o, c) {
    var r = ue.exec(o.slice(c));
    return r ? ((a.w = ae.get(r[0].toLowerCase())), c + r[0].length) : -1;
  }
  function ye(a, o, c) {
    var r = te.exec(o.slice(c));
    return r ? ((a.w = re.get(r[0].toLowerCase())), c + r[0].length) : -1;
  }
  function ge(a, o, c) {
    var r = fe.exec(o.slice(c));
    return r ? ((a.m = ie.get(r[0].toLowerCase())), c + r[0].length) : -1;
  }
  function he(a, o, c) {
    var r = oe.exec(o.slice(c));
    return r ? ((a.m = ce.get(r[0].toLowerCase())), c + r[0].length) : -1;
  }
  function Te(a, o, c) {
    return b(a, n, o, c);
  }
...
function f(e, n, t) {
  var u = e < 0 ? "-" : "",
    g = (u ? -e : e) + "",
    T = g.length;
  return u + (T < t ? new Array(t - T + 1).join(n) + g : g);
}
function Ae(e) {
  return e.replace(Oe, "\\$&");
}
function S(e) {
  return new RegExp("^(?:" + e.map(Ae).join("|") + ")", "i");
}
function d(e) {
  return new Map(e.map((n, t) => [n.toLowerCase(), t]));
}
function Ze(e, n, t) {
  var u = s.exec(n.slice(t, t + 1));
...
function Qe(e, n, t) {
  ...
  return u
    ? ((e.Z = u[1] ? 0 : -(u[2] + (u[3] || "00"))), t + u[0].length)
    : -1;
}
function Ve(e, n, t) {
  var u = s.exec(n.slice(t, t + 1));
...
function Ge(e, n, t) {
  var u = s.exec(n.slice(t, t + 6));
  return u ? ((e.L = Math.floor(u[0] / 1e3)), t + u[0].length) : -1;
}
function ze(e, n, t) {
  var u = Ne.exec(n.slice(t, t + 1));
  return u ? t + u[0].length : -1;
}
function $e(e, n, t) {
  var u = s.exec(n.slice(t));
...
function hn(e, n) {
  var t = e.getDay();
  return (
    (e = t >= 4 || t === 0 ? w(e) : w.ceil(e)), f(e.getFullYear() % 1e4, n, 4)
  );
}
function Tn(e) {
...
function wn(e, n) {
  return f(Fe.count(x(e) - 1, e), n, 2);
}
function K(e) {
  var n = e.getUTCDay();
  return n >= 4 || n === 0 ? k(e) : k.ceil(e);
}
function xn(e, n) {
  return (e = K(e)), f(k.count(x(e), e) + (x(e).getUTCDay() === 4), n, 2);
}
function kn(e) {
  return e.getUTCDay();
}
...
function Yn(e, n) {
  return (e = K(e)), f(e.getUTCFullYear() % 100, n, 2);
}
function bn(e, n) {
...
function Fn(e, n) {
  var t = e.getUTCDay();
  return (
    (e = t >= 4 || t === 0 ? k(e) : k.ceil(e)),
    f(e.getUTCFullYear() % 1e4, n, 4)
  );
}
function Hn() {
  return "+0000";
...
function An(e) {
  return (
    (C = He(e)), (Nn = C.format), C.parse, (On = C.utcFormat), C.utcParse, C
  );
}
export { Nn as t, On as u };
