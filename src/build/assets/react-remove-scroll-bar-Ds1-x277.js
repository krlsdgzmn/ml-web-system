...
import { s as f } from "./react-style-singleton-CANWrM8C.js";
var d = "right-scroll-bar-position",
  g = "width-before-scroll-bar",
  p = "with-scroll-bars-hidden",
  ...
  b = function (n) {
    var r = window.getComputedStyle(document.body),
      ...
      t = r[n === "padding" ? "paddingTop" : "marginTop"],
      e = r[n === "padding" ? "paddingRight" : "marginRight"];
    return [l(o), l(t), l(e)];
  },
  y = function (n) {
    if ((n === void 0 && (n = "margin"), typeof window > "u")) return m;
    var r = b(n),
...
`,
  ...
  u = function () {
    var n = parseInt(document.body.getAttribute(c) || "0", 10);
    return isFinite(n) ? n : 0;
  },
  S = function () {
    s.useEffect(function () {
      return (
        document.body.setAttribute(c, (u() + 1).toString()),
        function () {
          var n = u() - 1;
          n <= 0
            ? document.body.removeAttribute(c)
            : document.body.setAttribute(c, n.toString());
        }
      );
    }, []);
  },
  A = function (n) {
    ...
    return s.createElement(w, { styles: x(i, !r, e, o ? "" : "!important") });
  };
