...
function D(e, r) {
  ...
  const n = e.join($);
  return (s = r.validators.find(({ validator: a }) => a(n))) == null
    ? void 0
    : s.classGroupId;
}
const Q = /^\[(.+)\]$/;
...
function ie(e) {
  ...
  return (
    ae(Object.entries(e.classGroups), t).forEach(([n, s]) => {
      _(s, o, n, r);
    }),
    o
  );
    ...
    ? e.map(([t, o]) => {
        const l = o.map((n) =>
          typeof n == "string"
            ...
            : typeof n == "object"
              ? Object.fromEntries(
                  Object.entries(n).map(([s, a]) => [r + s, a]),
                )
              : n,
        );
        return [t, l];
...
function de(e) {
  ...
  return function (s) {
    ...
    for (let f = 0; f < s.length; f++) {
      let m = s[f];
      if (u === 0) {
        if (m === o && (t || s.slice(f, f + l) === r)) {
          a.push(s.slice(b, f)), (b = f + l);
          continue;
        }
        if (m === "/") {
          p = f;
    ...
    const g = a.length === 0 ? s : s.substring(b),
      h = g.startsWith(ee),
      w = h ? g.substring(1) : g,
      S = p && p > b ? p - b : void 0;
    return {
...
function pe(e) {
  return { cache: ce(e.cacheSize), splitModifiers: de(e), ...ne(e) };
}
const be = /\s+/;
function fe(e, r) {
  const {
  ...
  return e
    ...
    .filter((s) => {
      ...
      const { modifierId: a, classGroupId: u, hasPostfixModifier: b } = s,
        p = a + u;
      return n.has(p)
        ? !1
        : (n.add(p), l(u, b).forEach((g) => n.add(a + g)), !0);
    })
    .reverse()
...
function me(e, ...r) {
  ...
  function s(u) {
    ...
    return (t = pe(b)), (o = t.cache.get), (l = t.cache.set), (n = a), a(u);
  }
  function a(u) {
    const b = o(u);
    if (b) return b;
...
function x(e) {
  return C(e) || ye.has(e) || he.test(e);
}
function k(e) {
  return M(e, "length", Pe);
}
function C(e) {
...
const Se = new Set(["length", "size", "percentage"]);
function Me(e) {
  return M(e, Se, oe);
}
function Ae(e) {
  return M(e, "position", oe);
}
const Re = new Set(["image", "url"]);
function Ge(e) {
  return M(e, Re, je);
}
function Ie(e) {
...
function Ee() {
  ...
  return {
    ...
    theme: {
      ...
      gradientColorStopPositions: [Ce, k],
      inset: N(),
      margin: N(),
      opacity: R(),
      padding: d(),
    ...
    classGroups: {
      ...
      "bg-size": [{ bg: ["auto", "cover", "contain", Me] }],
      "bg-image": [
        {
          bg: [
            "none",
